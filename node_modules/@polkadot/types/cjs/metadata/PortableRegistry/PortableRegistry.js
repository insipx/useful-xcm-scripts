...
function removeDupeNames(lookup, portable, names) {
  ...
  return names.map((original, startAt) => {
    ...
    const paramIdx = params.findIndex((_ref2, index) => {
      let {
        type
      } = _ref2;
      return allSame.every((_ref3, aIndex) => {
        let {
          params
        } = _ref3;
...
class PortableRegistry extends _typesCodec.Struct {
  constructor(registry, value, isContract) {
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _types)[_types] = types; // console.log('PortableRegistry', `${(performance.now() - timeStart).toFixed(2)}ms`)
  }
...
function _extract2(type, lookupIndex) {
  ...
  let typeDef;
  const aliasType = (0, _classPrivateFieldLooseBase2.default)(this, _alias)[_alias][lookupIndex] || getAliasPath(type.path);
...
function _extractCompact2(_, _ref7) {
  let {
    type
  } = _ref7;
  return (0, _typesCreate.withTypeString)(this.registry, {
...
function _extractComposite2(lookupIndex, _ref8, _ref9) {
  let {
    params,
    path
  } = _ref8;
...
function _extractCompositeSet2(_, params, fields) {
  ...
  return (0, _typesCreate.withTypeString)(this.registry, {
    ...
    sub: this.getSiType(params[0].type.unwrap()).def.asVariant.variants.map(_ref11 => {
      let {
        index,
        name
      } = _ref11;
...
function _extractSequence2(lookupIndex, _ref12) {
  let {
    type
  } = _ref12;
...
function _extractVariant2(lookupIndex, _ref13, _ref14) {
  let {
    params,
    path
  } = _ref13;
...
function _extractVariantEnum2(lookupIndex, variants) {
  ...
  variants.slice().sort((a, b) => a.index.cmp(b.index)).forEach(_ref16 => {
    let {
      fields,
      index: bnIndex,
      name
