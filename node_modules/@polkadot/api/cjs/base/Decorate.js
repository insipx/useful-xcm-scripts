...
class Decorate extends _Events.Events {
  ...
  _getRuntimeDefs(registry, specName) {
    ...
    const result = {};
    const defValues = Object.values(_types.typeDefinitions); // options > chain/spec > built-in, apply in reverse order with
  ...
  _decorateStorageCall(creator, decorateMethod) {
    ...
    return decorateMethod(function () {
      ...
      const call = (0, _validate.extractStorageArgs)(_this3.#registry, creator, args);

      if (!_this3.hasSubscriptions) {
        return _this3._rpcCore.state.getStorage(call);
      }

      return _this3._queueStorage(call, _this3.#storageSubQ);
    }, {
      ...
      overrideNoSub: function () {
        ...
        return _this3._queueStorage((0, _validate.extractStorageArgs)(_this3.#registry, creator, args), _this3.#storageGetQ);
      }
    });
