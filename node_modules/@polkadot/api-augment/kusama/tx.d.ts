...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        hrmp: {
             ...
             * witness data.
             **/
            hrmpCancelOpenRequest: AugmentedSubmittable<(channelId: PolkadotParachainPrimitivesHrmpChannelId | {
                sender?: any;
                recipient?: any;
            } | string | Uint8Array, openRequests: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PolkadotParachainPrimitivesHrmpChannelId, u32]>;
            /**
             ...
             **/
            hrmpCloseChannel: AugmentedSubmittable<(channelId: PolkadotParachainPrimitivesHrmpChannelId | {
                sender?: any;
                recipient?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PolkadotParachainPrimitivesHrmpChannelId]>;
            /**
        ...
        nominationPools: {
            ...
            create: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array, root: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, stateToggler: MultiAddress | {
                Id: any;
            } | {
                Index: any;
            } | {
        ...
        paraInherent: {
             ...
             **/
            enter: AugmentedSubmittable<(data: PolkadotPrimitivesV2InherentData | {
                bitfields?: any;
                backedCandidates?: any;
                disputes?: any;
                parentHeader?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PolkadotPrimitivesV2InherentData]>;
            /**
             * Generic tx
             **/
            [key: string]: SubmittableExtrinsicFunction<ApiType>;
        ...
        paras: {
             ...
             **/
            includePvfCheckStatement: AugmentedSubmittable<(stmt: PolkadotPrimitivesV2PvfCheckStatement | {
                accept?: any;
                subject?: any;
                sessionIndex?: any;
                validatorIndex?: any;
            } | string | Uint8Array, signature: PolkadotPrimitivesV2ValidatorAppSignature | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PolkadotPrimitivesV2PvfCheckStatement, PolkadotPrimitivesV2ValidatorAppSignature]>;
            /**
        ...
        proxy: {
            ...
            addProxy: AugmentedSubmittable<(delegate: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, proxyType: KusamaRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'IdentityJudgement' | 'CancelProxy' | 'Auction' | 'Society' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, KusamaRuntimeProxyType, u32]>;
            /**
             ...
             * # </weight>
             **/
            killAnonymous: AugmentedSubmittable<(spawner: MultiAddress | {
                Id: any;
            } | {
                Index: any;
            } | {
                ...
                Address20: any;
            } | string | Uint8Array, proxyType: KusamaRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'IdentityJudgement' | 'CancelProxy' | 'Auction' | 'Society' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, KusamaRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
            /**
        ...
        session: {
             ...
             * # </weight>
             **/
            setKeys: AugmentedSubmittable<(keys: KusamaRuntimeSessionKeys | {
                grandpa?: any;
                babe?: any;
                imOnline?: any;
                paraValidator?: any;
            ...
            } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [KusamaRuntimeSessionKeys, Bytes]>;
            /**
             * Generic tx
             **/
            [key: string]: SubmittableExtrinsicFunction<ApiType>;
        ...
        society: {
             ...
             * # </weight>
             **/
            found: AugmentedSubmittable<(founder: MultiAddress | {
                Id: any;
            } | {
                Index: any;
            } | {
                ...
                Address20: any;
            } | string | Uint8Array, maxMembers: u32 | AnyNumber | Uint8Array, rules: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, u32, Bytes]>;
            /**
             ...
             * # </weight>
             **/
            judgeSuspendedCandidate: AugmentedSubmittable<(who: MultiAddress | {
                Id: any;
            } | {
                Index: any;
            } | {
                ...
                Address20: any;
            } | string | Uint8Array, judgement: PalletSocietyJudgement | 'Rebid' | 'Reject' | 'Approve' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, PalletSocietyJudgement]>;
            /**
        ...
        utility: {
             ...
             * # </weight>
             **/
            dispatchAs: AugmentedSubmittable<(asOrigin: KusamaRuntimeOriginCaller | {
                system: any;
            } | {
                Void: any;
            } | {
                ...
                XcmPallet: any;
            } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [KusamaRuntimeOriginCaller, Call]>;
            /**
             * Send a batch of dispatch calls.
